...
public:
	...
	int getSize() const;
	void render(char c, const glm::vec2 &pixel, float size, const glm::vec4 &color);
	void render(const string &str, const glm::vec2 &pixel, float size, const glm::vec4 &color);
