...
enum Objects{NoObj = 0, Baba = 1, Flag = 2, Wall = 3, Rock = 4, Water = 5};
static const char* ObjectStrings[] = { "", "BabaM", "FlagM", "WallM" , "RockM","WaterM"};
enum Relations{Is = 1, And = 2};
static const char* RelationStrings[] = { "", "Is", "And"};
enum Properties {You = 1, Stop = 2, Win = 3, Push = 4, Sink = 5};
static const char* PropertyStrings[] = { "", "You", "Stop","Win","Push", "Sink"};
